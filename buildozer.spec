...
# (str) Package name
package.name = liontv.app

# (str) Package domain (needed for android/ios packaging)
package.domain = com.liontv

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (leave empty to include all the files)
source.include_exts = py,png,jpg,kv,jfif,atlas
...
presplash.filename = %(source.dir)s/data/lion.png

# (str) Icon of the application
icon.filename = %(source.dir)s/data/lion.png
...
android.permissions = android.permission.INTERNET,WAKE_LOCK  (name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=18)
